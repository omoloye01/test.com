<?php
 include 'connect.php';
 $id=$_GET['updateid'];
 $sql="Select * from `tb_rep` where id=$id";
 ...
 if(isset($_POST['submit'])){
  ...
  $sql="update `tb_rep` set id=$id,name='$name',email='$email' where id=$id   ";
  $result=mysqli_query($con,$sql);
  if($result){
...
<form method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter recipe name" name="name" value=<?php echo $name ?>>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter recipe ingridient">
  </div>
  <div class="form-group">
    <label>Ingridient</label>
    <input type="text" class="form-control" placeholder="Enter recipe ingridient">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter preparation">
  </div>
  <div class="form-group">
    <label>Serving</label>
    <input type="text" class="form-control" placeholder="Enter preparation" name="email" value=<?php echo $email ?>>
  </div>
