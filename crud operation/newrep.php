<?php
 ...
 if(isset($_POST['submit'])){
  ...
  $sql="insert into `tb_rep` (name,email) values('$name','$email')";
...
<form method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Enter recipe name" name="name">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label>Serving</label>
    <input type="text" class="form-control" placeholder="Enter preparation" name="email">
  </div>
  
  <button type="submit" class="btn btn-success" name="submit">Add Recipe</button>
</form>
</div>
</section>
</body>
