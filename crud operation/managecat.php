  ...
  <tbody>
    ...
    if($result){
       while($row=mysqli_fetch_assoc($result)){
        ...
        <td>'.$email.'</td>
        <td>
        <a href="catupdate.php?updateid='.$id.'"><button class="btn btn-success">Edit</button> </a>
        <a href="catdelete.php?deleteid='.$id.'"><button class=" btn-danger">Delete</button> </a>
     </td>
      </tr>';
       }
    }
...
<a href="#"> <button class="btn btn-success my-5">Return Home</button></a>
<a href="newcat.php"> <button class="btn btn-success my-5">Add category</button></a>
</div>
</section>
</body>
</html>