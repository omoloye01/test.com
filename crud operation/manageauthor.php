  ...
  <tbody>
    ...
    if($result){
       while($row=mysqli_fetch_assoc($result)){
        ...
        <td>'.$email.'</td>
        <td>
        <a href="update.php?updateid='.$id.'"><button class="btn btn-success">Edit</button> </a>
        <a href="delete.php?deleteid='.$id.'"><button class=" btn-danger">Delete</button> </a>
     </td>
      </tr>';
       }
    }
...
<a href="newauthor.php"> <button class="btn btn-success my-5">Add Author</button></a>
</div>
</section>
</body>
</html>